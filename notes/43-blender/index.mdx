...
- Use [Linked Objects](https://www.youtube.com/watch?v=ENdGhAM3NzA) (simple) or
  [Collection Instances](https://blender.stackexchange.com/a/259870/105541) (advanced) to reuse
  objects. The latter allows you to edit your mesh in one place and have the changes reflected in
  all instances.

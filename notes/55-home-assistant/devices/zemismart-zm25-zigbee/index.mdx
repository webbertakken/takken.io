...
There are 3 remotes that I know of. From left to right the `ZC175A-9`, `ZC123a-1` and `ZC171A-1`.
...
I've configured my setup using the `ZC171A-1` remote (see steps below). The `Set` button in the back
is important.
...
- For the hardware part I used a [blog post](https://m.blog.naver.com/2kiu/221955091776)
  <sup>(translation\: [English](./assets/BlogPost-JayN-ZemismartZigbeeRollerShadeMotor.pdf))</sup>
  by JayN as a reference.

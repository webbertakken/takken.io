...
Since Git is [not so well suited](https://stackoverflow.com/a/17723552/3593896) for repositories over 1 gigabyte, it's better to use Perforce for Unreal Engine projects.

Perforce has a server and a client component. The server is called _Helix Core_ and the client is called _P4V_.
...
- Workspace: A local copy of the depot.
- Depot: A repository of files.
...
Creating a Depot, TypeMap and mapping a workspace to it.

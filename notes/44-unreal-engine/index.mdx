...
Since Git isn't so well suited for repositories over 100 megabytes, it's better to use Perforce for Unreal Engine projects.

We will also be using the newer Stream-Depot model, which is more suited for Unreal Engine projects.

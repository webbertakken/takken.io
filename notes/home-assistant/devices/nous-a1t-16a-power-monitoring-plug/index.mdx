...
If you used a resistive load, like an incandescent light bulb, the Active Power reading should be
the same as the Apparent Power reading. In this example they are set to 42W and 42VA respectively.
